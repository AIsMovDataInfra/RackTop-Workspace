            ...
            {draft.authMethod === 'sshAgent' && (
              <details className="key-guide">
                ...
                <div className="key-guide__toolbar">
                  <span className="key-guide__platform-label">已检测：{setupPlatform === 'windows' ? '本机 Windows PowerShell → 远程 Linux' : /Linux/i.test(navigator.userAgent) ? '本机 Linux 终端 → 远程 Linux' : '本机 macOS Terminal → 远程 Linux'}</span>
