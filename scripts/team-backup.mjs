...
// Resolve both sides: production invokes this script through the current release symlink.
// A library import (including node -e with an unrelated argument) must remain inert.
