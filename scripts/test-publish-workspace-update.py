...
class WorkspaceRelease(unittest.TestCase):
    ...
    def test_publication_checksums_and_atomic_feeds_cover_both_linux_formats(self):
        ...
        self.assertIn('## 下载\n\n推荐从[统一下载页](https://136.0.110.161/downloads/)', body)
        self.assertIn(f'https://github.com/{publisher.REPO}/blob/main/docs/DOWNLOADS.md', body)
        self.assertNotIn(f'/blob/v{self.version}/docs/LINUX.md', body)
