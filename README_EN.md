...
**Current version: 2.7.0 Pre-release.** For Ubuntu 20.04 / 22.04, run the unified installer below. On Mac, choose the DMG for your chip on the download page. No source build or development tools are required.
...
| --- | --- | --- |
| Ubuntu 20.04, Intel / AMD 64-bit | [Flatpak offline kit](https://136.0.110.161/downloads/RackTop_2.7.0_linux-amd64-flatpak-offline.tar.gz) | [Download](https://github.com/AIsMovDataInfra/RackTop-Workspace/releases/download/v2.7.0/RackTop_2.7.0_linux-amd64-flatpak-offline.tar.gz) |
| Ubuntu 22.04, Intel / AMD 64-bit | [DEB package](https://136.0.110.161/downloads/RackTop_2.7.0_linux-amd64.deb) | [Download](https://github.com/AIsMovDataInfra/RackTop-Workspace/releases/download/v2.7.0/RackTop_2.7.0_linux-amd64.deb) |
| Mac with an M-series chip | [Apple Silicon DMG](https://136.0.110.161/downloads/RackTop_2.7.0_macos-arm64-unsigned.dmg) | [Download](https://github.com/AIsMovDataInfra/RackTop-Workspace/releases/download/v2.7.0/RackTop_2.7.0_macos-arm64-unsigned.dmg) |
| Mac with an Intel processor | [Intel DMG](https://136.0.110.161/downloads/RackTop_2.7.0_macos-x64-unsigned.dmg) | [Download](https://github.com/AIsMovDataInfra/RackTop-Workspace/releases/download/v2.7.0/RackTop_2.7.0_macos-x64-unsigned.dmg) |
