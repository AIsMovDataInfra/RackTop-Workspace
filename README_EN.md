...
**Current version: 2.8.0 Pre-release.** For Ubuntu 20.04 / 22.04, run the unified installer below. On Mac, choose the DMG for your chip on the download page. No source build or development tools are required.
...
| --- | --- | --- |
| Ubuntu 20.04, Intel / AMD 64-bit | [Flatpak offline kit](https://136.0.110.161/downloads/RackTop_2.8.0_linux-amd64-flatpak-offline.tar.gz) | [Download](https://github.com/AIsMovDataInfra/RackTop-Workspace/releases/download/v2.8.0/RackTop_2.8.0_linux-amd64-flatpak-offline.tar.gz) |
| Ubuntu 22.04, Intel / AMD 64-bit | [DEB package](https://136.0.110.161/downloads/RackTop_2.8.0_linux-amd64.deb) | [Download](https://github.com/AIsMovDataInfra/RackTop-Workspace/releases/download/v2.8.0/RackTop_2.8.0_linux-amd64.deb) |
| Mac with an M-series chip | [Apple Silicon DMG](https://136.0.110.161/downloads/RackTop_2.8.0_macos-arm64-unsigned.dmg) | [Download](https://github.com/AIsMovDataInfra/RackTop-Workspace/releases/download/v2.8.0/RackTop_2.8.0_macos-arm64-unsigned.dmg) |
| Mac with an Intel processor | [Intel DMG](https://136.0.110.161/downloads/RackTop_2.8.0_macos-x64-unsigned.dmg) | [Download](https://github.com/AIsMovDataInfra/RackTop-Workspace/releases/download/v2.8.0/RackTop_2.8.0_macos-x64-unsigned.dmg) |
...
**The 2.8.0 team website and desktop packages are available.** New GPU usage summaries require an administrator to upgrade to 2.8.0 and keep collection running; without fresh observations, usage is unknown. See [the changes](docs/Version_overview.md) (Chinese).
...
- **Team SSH:** Admins maintain server resources, enter existing SSH passwords, and grant access. Members sign in on desktop 2.8.0, select an organization, and connect with the assigned credentials. Local passwords, private keys, and SSH Agent remain available when no shared password is provided. [Instructions](docs/WORKSPACE.md#统一管理-ssh-服务器) (Chinese).
