...
Current Linux source version: **1.26.0-linux.3**; the download table retains the latest published pre-release for **Ubuntu 22.04 x86_64 / amd64 desktops**. The upstream feature guide and screenshots appear below; see [Linux validation and limitations](docs/LINUX.md#验证范围) for the scope tested on Linux.
