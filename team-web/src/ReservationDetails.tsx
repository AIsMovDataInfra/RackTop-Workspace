...
export function ReservationDetails({ id, user, onClose, onAction, t, locale }: { id: string; user: User | null; onClose: () => void; onAction: (action: 'renew' | 'cancel' | 'finish', reservation: Reservation) => void; t: Translate; locale: Locale }) {
