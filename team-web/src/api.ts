...
export const api = {
  ...
  renew: (reservation: Reservation, endAt: string) => request<{ reservation: Reservation }>(`/reservations/${encodeURIComponent(reservation.id)}`, 'PATCH', { version: reservation.version, endAt }),
