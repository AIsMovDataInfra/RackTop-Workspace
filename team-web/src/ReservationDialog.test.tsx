...
describe('reservation interactions', () => {
  it('keeps the full draft when a 409 is returned and shows the conflicting member and slot', async () => {
    ...
    await submit()
    expect(reserve).toHaveBeenCalledWith({ resourceId: resource.id, scope: 'gpus', gpuIndices: [1], startAt: '2030-09-09T02:00:00.000Z', endAt: '2030-09-09T03:00:00.000Z', purpose: '我自己的新训练任务' })
